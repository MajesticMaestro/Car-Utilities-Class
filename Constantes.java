...
public final class Constantes {
    ...
    //NODE pour l'envoi et le Retour des donnee au serveur
    public static final String NODE_USERNAME = "username";
    public static final String NODE_USERNAME_MESSAGE_ID = "username";
    public static final String NODE_NOM = "nom";
    public static final String NODE_PRENOM = "prenom";
    public static final String NODE_PROFIL = "profil";
